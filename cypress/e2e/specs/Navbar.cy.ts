...
describe('Navbar E2E Tests', () => {
  ...
  describe('Funcionalidad de autenticación', () => {
    it('Debe mostrar el email del usuario autenticado', () => {
      const email = 'usuario@live.uleam.edu.ec';
  ...
  describe('Estilos y diseño', () => {
    ...
    it('Los enlaces de navegación deben tener estilos correctos', () => {
      cy.get('.nav-links a').should('have.css', 'color');
      cy.get('.login-nav-link').should('exist');
      cy.get('.register-nav-link').should('exist');
  ...
  describe('Diseño responsive', () => {
    ...
    it('Debe ocultar los enlaces de navegación en dispositivos móviles', () => {
      cy.viewport('iphone-x');
      cy.get('.nav-links').should('have.css', 'display', 'none');
    });
